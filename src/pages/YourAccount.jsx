...
const YourAccount = () => {
  ...
  return (
    ...
    <>
      <Helmet>
        <title>My Account | DressCode - Manage Orders & Address</title>
        <meta name="description" content="Access your Dresscode profile to manage orders, wishlist, and shipping addresses. Track your school uniform, corporate workwear, and medical scrub purchases with ease." />
      </Helmet>
